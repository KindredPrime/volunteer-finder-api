...
const OrganizationsService = {
  ...
  */
   ...
   * org_causes tables.
   *
   * @param {Object} db - the database instance to connect to
   * @param {Object} fullOrg - the organization, with its causes, to add to the database
   * @return {Promise}
   */
   ...
   * @param {Object} newFields - All of the organization-related fields to be updated
   * @return {Array}
   */
   ...
   *
   * @param {JSON Object} rows - the query results to be converted
   * @return {Object}
   */
